    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative group overflow-hidden rounded-lg min-h-[600px] bg-blue-50">
            ...
            <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-between">
              ...
              <div>
                <button className="bg-[#68cfa3] hover:bg-[#5abf94] text-gray-900 px-8 py-4 rounded-full text-sm font-semibold flex items-center gap-2 transition-all shadow-lg shadow-teal-900/10 w-fit mt-12">
          ...
          <div className="relative overflow-hidden rounded-lg min-h-[600px] bg-[#E3E8DE]">
            <div className="relative z-10 p-8 md:p-12 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <button className="bg-[#1f2937] hover:bg-gray-800 text-white px-8 py-4 rounded-full text-sm font-semibold flex items-center gap-2 transition-all w-fit mt-12">
