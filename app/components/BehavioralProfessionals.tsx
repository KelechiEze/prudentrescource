...
const BehavioralProfessionals: React.FC = () => {
  const professionals = [
    "Licensed Professional",
    "Registered Nurses (RN)",
    "Licensed Practical Nurses",
    "Licensed Practical Nurses", // Keeping duplicates as per request/image
    ...
    <section className="py-24 bg-[#E3E8DE]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h2 className="font-serif text-4xl md:text-5xl text-[#1B2C42] mb-12 max-w-4xl leading-tight">
          ...
          to gain access to job opportunities include:
        </h2>
...
export default BehavioralProfessionals;
