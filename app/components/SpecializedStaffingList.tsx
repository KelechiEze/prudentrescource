      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-20">
          <div className="max-w-4xl">
            <h2 className="font-serif text-[42px] md:text-[56px] lg:text-[64px] text-[#1B2C42] leading-[1.05] mb-8 tracking-tight">
              Specialized Healthcare Staffing
            </h2>
            <p className="text-gray-600 text-lg md:text-[20px] leading-relaxed font-light max-w-3xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 relative rounded-[24px] overflow-hidden shadow-2xl h-[400px] md:h-[550px] lg:h-[600px] w-full">
            <img 
