...
INSERT INTO job_listings (title, role, city, state, job_type, duties, skills, contract_length, working_days, working_hours, wages, additional_description) VALUES
('Richmond Support Homes', 'Direct Support Professional', 'Charlottesville', 'California', 'Contract Role', 'Assist residents with Activities of Daily Living (ADLs). Monitor residents health by taking vital signs, observing changes in behavior or condition, and reporting findings accurately. Administer medications following prescribed care plans while adhering to HIPAA regulations to maintain confidentiality.', 'Valid drivers license. Vehicle Registration Required. Negative TB/PPD completed in the last 6 months. CPR/FA/AED from either American Red Cross or American Heart Association. Clean background.', '26 Weeks', '5 days/week', '24 hours/day', '$30/hour', 'Our Client is seeking a dedicated and compassionate Direct Support Professional to provide essential assistance and care to individuals with developmental disabilities, mental health challenges, or age-related conditions such as dementia and Alzheimer''s disease. The ideal candidate will play a vital role in promoting independence, ensuring safety, and enhancing the quality of life in a group home setting.'),
('Maryland Care Center', 'Registered Nurse (RN)', 'Baltimore', 'Maryland', 'Contract Role', 'Provide direct nursing care to patients. Administer medications and treatments. Collaborate with healthcare team members. Maintain patient records.', 'Valid RN license. BLS certification. 2+ years of experience. Strong communication skills.', '13 Weeks', '5 days/week', '12 hours/day', '$45/hour', 'Seeking experienced Registered Nurse for long-term care facility.');